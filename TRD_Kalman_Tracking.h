...
ClassImp(Ali_TRD_ST_Tracklets)
   ...
   private:
    ...
    Double_t mTRD_layer_radii[6][3] = {{0, 297.5, 306.5}, {0, 310.0, 320.0}, {0, 323.0, 333.0},
                                       {0, 336.0, 345.5}, {0, 348.0, 357.0}, {0, 361.0, 371.0}};
   ...
   public:
    std::vector<std::vector<Ali_TRD_ST_Tracklets*>> Kalman_Trackfit(std::vector<std::vector<Ali_TRD_ST_Tracklets*>> tracks,
                                                                    Int_t prim_vertex);
    std::vector<std::vector<Ali_TRD_ST_Tracklets*>> Kalman_Trackfind(Ali_TRD_ST_Tracklets** Tracklets, Int_t Num_Tracklets,
                                                                     Int_t prim_vertex);
